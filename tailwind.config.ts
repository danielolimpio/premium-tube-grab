  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "fade-in-up-delay": "fade-in-up 0.8s cubic-bezier(0.4, 0, 0.2, 1) 0.2s forwards",
        "scale-in": "scale-in 0.6s cubic-bezier(0.4, 0, 0.2, 1) 0.4s forwards",
